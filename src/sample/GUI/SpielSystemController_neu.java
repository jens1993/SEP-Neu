...
public class SpielSystemController_neu implements Initializable
{
    ...
    @FXML
    private RadioButton radio_platzDreiAusspielenNein;
...
//        System.out.println(spielerneu.getNName());
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        t_suchleistespieler.setText(titel);
        ...
        t_suchleistesetzliste.setText(titel);

        try
        {
            ResourceBundle bundle = ResourceBundle.getBundle( baseName );
            titel = bundle.getString("btnentf");
        }
        catch ( MissingResourceException e ) {
            System.err.println( e );
        }
        btnentf.setText(titel);
        ...
        {
            ResourceBundle bundle = ResourceBundle.getBundle( baseName );
            titel = bundle.getString("t_ArtDerTrost");
        }
        catch ( MissingResourceException e ) {
            System.err.println( e );
        }
        t_ArtDerTrost.setText(titel);
        ...
        {
            ResourceBundle bundle = ResourceBundle.getBundle( baseName );
            titel = bundle.getString("btn_spielklasseStarten");
        }
        catch ( MissingResourceException e ) {
            System.err.println( e );
        }
        btn_spielklasseStarten.setText(titel);
